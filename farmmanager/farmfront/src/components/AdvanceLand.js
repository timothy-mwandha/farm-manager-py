...
// import { fetchAdvances } from "../actions/advanceActions";
...
//           <Text>{advance.name}</Text>
//           <Text>{advance.gender}</Text>
//           <Text>{advance.position}</Text>
//           <Text>{advance.status}</Text>
//           <Text>{advance.advancedamnt}</Text>
//           <Text>{advance.description}</Text>
//         </View>
//         <TouchableOpacity
//           style={styles.TouchableOpacityStyle}
//           onPress={() => navigation.navigate("advance")}
...
//   fetchAdvances: PropTypes.func.isRequired,
...
// export default connect(mapStateToProps, { fetchAdvances })(AdvanceLand);
